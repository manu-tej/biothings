      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          ...
          trend={{
            ...
            percentage: workflowsArray.length > 0 ? Math.round((runningWorkflows / workflowsArray.length) * 100) : 0,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="secondary" outline>Last 24h</Badge>
          </div>
          <MetricChart
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="secondary" outline>Real-time</Badge>
          </div>
          <MetricChart
