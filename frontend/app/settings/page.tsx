...
export default function SettingsPage() {
            ...
            <div key={key} className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {key === 'agentAlerts' && 'Notifications when agents complete tasks or encounter issues'}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Automatically backup system data daily</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Use compact layout to show more information</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
  ...
  const renderContent = () => {
    switch (activeCategory) {
      ...
      default: return <div>Settings category not found</div>
    }
  }
