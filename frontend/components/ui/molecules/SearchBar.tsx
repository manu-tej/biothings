...
export const SearchBar = forwardRef<HTMLDivElement, SearchBarProps>(
  (
    ...
    return (
      <div ref={containerRef} className={clsx('relative w-full', className)} data-testid={testId}>
            ...
            <div className="relative">
              ...
              >
                ...
                {activeFiltersCount > 0 && (
                  <Badge size="xs" variant="primary" className="absolute -top-1 -right-1">
                    {activeFiltersCount}
                  </Badge>
                )}
              ...
              <div className="space-y-1">
                ...
                {suggestions.map((suggestion) => {
                  ...
                  return (
                    ...
                    >
                      {SuggestionIcon && <SuggestionIcon className="w-4 h-4 text-gray-400" />}
