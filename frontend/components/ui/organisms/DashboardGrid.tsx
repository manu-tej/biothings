...
export const DashboardGrid = forwardRef<HTMLDivElement, DashboardGridProps>(
  (
    ...
    const handleItemUpdate = useCallback((itemId: string, updates: Partial<DashboardGridItem>) => {
    ...
    const handleFullscreen = useCallback((itemId: string) => {
      ...
      return (
        <div
          ...
          className={clsx(
            ...
            isActive ? 'border-blue-400 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600',
    ...
    const renderGrid = () => {
      ...
      return (
        <div
          className={clsx(
            'grid w-full',
            showGrid && 'bg-gray-50 dark:bg-gray-900/50'
          )}
          style={{
        ...
        >
          ...
          {draggedItem && editable && allowDrag && 
    ...
    return (
      ...
      >
        ...
        {/* Fullscreen overlay */}
        {isFullscreen && (
          <div className="fixed inset-0 bg-black/50 z-999" onClick={() => handleFullscreen(fullscreenItem!)} />
        )}
      </div>
    );
  }
