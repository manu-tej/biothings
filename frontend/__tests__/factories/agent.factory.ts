...
export const createAgentsByType = (): Record<string, Agent> => ({
  ceo: createAgent({ id: 'ceo-001', name: 'CEO Agent', agent_type: 'CEO', department: 'Executive' }),
  cto: createAgent({ id: 'cto-001', name: 'CTO Agent', agent_type: 'CTO', department: 'Technology' }),
  cfo: createAgent({ id: 'cfo-001', name: 'CFO Agent', agent_type: 'CFO', department: 'Finance' }),
  lab: createAgent({ id: 'lab-001', name: 'Lab Agent', agent_type: 'Lab', department: 'Laboratory' }),
});