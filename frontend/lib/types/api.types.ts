...
export interface CreateWorkflowRequest {
  ...
  description?: string;
  type: WorkflowType;
  steps: Omit<WorkflowStep, 'id' | 'status' | 'output' | 'error' | 'startedAt' | 'completedAt' | 'duration'>[];
  variables?: Record<string, any>;
...
export function isPaginatedResponse<T>(response: ApiResponse<T>): response is ApiResponse<T> & { metadata: ResponseMetadata & { pagination: PaginationInfo } } {
