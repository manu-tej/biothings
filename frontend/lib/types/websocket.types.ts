...
export function isWebSocketNotification(message: WebSocketMessage): message is WebSocketNotification {
  return message.type === 'notification';
}

export function isWebSocketError(message: WebSocketMessage): message is WebSocketMessage & { error: WebSocketError } {
