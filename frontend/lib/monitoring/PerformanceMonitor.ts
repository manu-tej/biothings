...
export class PerformanceMonitor {
  ...
  public recordRenderMetric(componentName: string, renderTime: number, rerenderCount = 1): void {
    ...
    this.addPerformanceMetric(
      ...
      'render',
      'ms',
      this.alertThresholds.renderTime
    )
  ...
  public recordNetworkMetric(
    ...
    this.addPerformanceMetric(
      ...
      'network',
      'ms',
      this.alertThresholds.networkLatency
    )
  ...
  public getSlowestComponents(limit = 5): ComponentRenderMetric[] {
    const componentAverages = new Map<
      string,
      { total: number; count: number; latest: ComponentRenderMetric }
    >()
